        ...
        <Row v-show="openSearch" @keydown.enter.native="handleSearch">
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="shelfId">
                        <Select v-model="searchForm.shelfId" placeholder="所属货架" clearable style="width: 150px">
                            <Option v-for="(item,index) in shelfList" :key="index" :value="item.id">{{ item.title }}</Option>
                        </Select>
                    </Form-item>
                    <Form-item label="" prop="packageType">
                        <Select v-model="searchForm.packageType" placeholder="包装类型" clearable style="width: 150px">
                            <Option v-for="(item,index) in typeList" :key="index" :value="item.id">{{ item.title }}</Option>
                        </Select>
                    </Form-item>
                    <Form-item label="" prop="receivingUser">
                        <Input type="text" v-model="searchForm.receivingUser" placeholder="收件人" clearable style="width: 150px" />
                    </Form-item>
                    <Form-item label="" prop="sendUser">
                        <Input type="text" v-model="searchForm.sendUser" placeholder="发件人" clearable style="width: 150px" />
                    </Form-item>
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getExpressList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
