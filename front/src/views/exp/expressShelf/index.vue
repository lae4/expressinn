        ...
        <Row v-show="openSearch" @keydown.enter.native="handleSearch">
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="areaId">
                        <Select v-model="searchForm.areaId" placeholder="所属区域" clearable style="width: 150px">
                            <Option v-for="(item,index) in areaList" :key="index" :value="item.id">{{ item.title }}</Option>
                        </Select>
                    </Form-item>
                    <Form-item label="" prop="title">
                        <Input type="text" v-model="searchForm.title" placeholder="货架名称" clearable style="width: 150px" />
                    </Form-item>
                    <Form-item label="" prop="status">
                        <Select v-model="searchForm.status" placeholder="货架状态" clearable style="width: 150px">
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getExpressShelfList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
